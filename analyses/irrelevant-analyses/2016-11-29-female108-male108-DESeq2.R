...
png("/Users/yaamini/Documents/yaaminiv-fish546-2016/analyses/irrelevant-analyses/11-29-oly-oa-gonad-DESeq2/female108-male108.png", width = 800, height = 800)
plot(tmp$baseMean, tmp$log2FoldChange, pch=20, cex=0.45, ylim=c(-3, 3), log="x", col="darkgray", main="Differentially Expressed Genes in Female_108 vs. Male_108  (pval <= 0.05)", xlab="mean of normalized counts", ylab="Log2 Fold Change")
#Getting the significant points and plotting them again so they're a different color
tmp.sig <- deseq2.res[!is.na(deseq2.res$padj) & deseq2.res$padj <= 0.05, ]
points(tmp.sig$baseMean, tmp.sig$log2FoldChange, pch=20, cex=0.45, col="violetred")
...
write.table(tmp.sig, "/Users/yaamini/Documents/yaaminiv-fish546-2016/analyses/irrelevant-analyses/11-29-oly-oa-gonad-DESeq2/female108-male108_DEG.tab", row.names = T)