...
#Set variables
echo Set variables
echo directoryName="irrelevant-analyses"
...
echo cd /Users/yaamini/Documents/yaaminiv-fish546-2016/analyses
...
echo if [ $? -ne 0 ] then echo "Couldn't change to desired directory. Make sure target directory exists before executing script." fi
if [ $? -ne 0 ]
...
echo find *kallisto* -type d | xargs -I '{}' mv '{}' irrelevant-analyses
